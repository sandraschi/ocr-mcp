                    ...
                    <div key={step} className="text-xs text-slate-400">
                      ...
                      {stepResult?.text ? (
                        <span className="text-slate-300">
                          {String(stepResult.text).slice(0, 120)}
                          {stepResult.text.length > 120 ? "…" : ""}
                        </span>
                      ) : (
                        <span>
                          {stepResult?.status || stepResult?.reason || JSON.stringify(stepResult).slice(0, 80)}
                        </span>
                      )}
                    </div>
                  ))}
