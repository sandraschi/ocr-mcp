        ...
        <div className="flex h-[calc(100vh-8rem)] flex-col space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400">Natural language OCR pipeline control (LLM)</p>
                </div>
            </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <p className="text-sm text-slate-300 bg-slate-900/50 p-3 rounded-md border border-slate-800 inline-block">
                                Identify tables in the scanned document and structure them as CSV.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <div className="text-sm text-slate-300 bg-blue-950/10 p-3 rounded-md border border-blue-900/30 inline-block">
                                <p>Acknowledged. Distributing task to optimal backend...</p>
                                <br />
                                <p className="font-mono text-emerald-400 text-xs">
                                    {">"} EVALUATING_JOB: Table Extraction <br />
                                    {">"} BACKEND_SELECTED: Florence-2<br />
                                    {">"} STATUS: PROCESSING (ETA 14s)
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-4 border-t border-slate-800 bg-slate-900/30">
                    <div className="flex gap-2">
                        <input
                            ...
                            placeholder="Enter a prompt for the OCR pipeline..."
                        />
